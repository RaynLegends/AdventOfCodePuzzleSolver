...
public class _17_2_Puzzle implements Puzzle {
	...
	public String calculate(String input) {
		...
		int	totalCombinations = PuzzleUtils.validCombinationsAmount(containers, highestContainersNumberToReachLiters, new CombinationValidator<Byte>() {
